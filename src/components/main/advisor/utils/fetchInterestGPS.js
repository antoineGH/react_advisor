...
export default async function fetchInterestGPS(gps, limit) {
	const latLng = `${gps.lat},${gps.lng}`
	const urlToFetch = `${url}${latLng}&limit=${limit}&client_id=${clientId}&client_secret=${clientSecret}&v=20200921`
