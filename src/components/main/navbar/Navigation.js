...
import { ReactComponent as HorizontalLogo } from '../../../static/horizontal_logo.svg'
				...
				<Navbar
					...
					<Row style={{ width: '100%' }}>
						<Col md={12} className='text-left justify-content-left'>
							<Navbar.Brand href='/' style={{ maxHeight: '5vh', maxWidth: '15vh' }}>
								<HorizontalLogo style={{ width: '100%', height: '100%' }} className='img-fluid' />
							</Navbar.Brand>
						</Col>
						<Col md={12} style={{ padding: 0 }} className='text-left justify-content-left'>
							<LocationSearch handleSearch={handleSearch} handleClick={handleClick} placeHolder='Where to?' />
						</Col>
					</Row>
				</Navbar>
			</Container>
